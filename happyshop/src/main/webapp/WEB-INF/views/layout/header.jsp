...
<nav id="navbar" class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: #F8F8FF; border-bottom: 1px solid gainsboro;">
	<div class="container ">
		<div class="row" style="padding: 20px 15px 12px;">
			<div class="col-sm-4" style="margin-top: -15px; padding-left: 30px;">
				<a href="/"><img src="/static/images/logo1.png" alt="" width="80%"></a>
			</div>
			<div class="col-sm-4" style="padding-right: 15px;">
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						<input style="width: 240px; height: 34px; font-size: 14px;" class="form-control" value="${param.keywords}" name="keywords" placeholder="Tìm kiếm" />
			...
			<div class="col-sm-4" style="padding: 0px 35px;">
				<div class="row">
						...
						<div class="header-menu">
							<div class="card-hover" id="cart-img">
								<div class="card-sp">
									<ul>
										<li>
											<a href="/cart/view" style="text-decoration: none; display: flex; align-items: center;">
												<img src="\static\images\icon\cart.png" alt="Giỏ hàng" style="width: 45px;">
												<p class="carts" style="margin: 0 0 0 10px; font-size: 16px; color: #474c51;">Giỏ hàng</p></a>
											<ul>
												<li>
													<div class="row">
														<c:choose>
											...
											<div class="tong-tien">
												...
												<br />
												<div>
													<a style="width: 360px" class="btn btn-primary" href="/cart/view">Xem giỏ hàng</a>
												</div>
											</div>
										</li>
									</ul>
					...
					<div class="col-sm-6">
						<div class="header-menu">
							<a class="splike" href="/product/favo" style="text-decoration: none; display: flex; align-items: center;">
								<img src="\static\images\icon\favourite.png" alt="Sản phẩm đã thích" style="width: 45px; padding: 0px 0px -1px 5px;">
								<span style="margin-left: 10px; font-size: 14px; color: #474c51;">Sản phẩm<br>đã thích</span>
							</a>
						</div>
					</div>					
				</div>
