				...
				<div class="col-sm-3" style="padding: 5px 5px 5px 5px">
					<div class="thumbnail">
						...
						<a href="/product/detail/${p.id}">
							...
							<c:choose>
								<c:when test="${p.discount > 0 }">
									<p
										...
										<span
											style="margin-left: -28px;margin-top: 5px;font-size: 14px;color: #fff;position: absolute;">-<f:formatNumber value="${p.discount}" type="percent" />
										</span>
									</p>
								</c:when>
								<c:otherwise>
							...
							<img style="margin-right: 30px;margin-top: 5px" class="estore-prod"
								src="/static/images/products/${p.image}" title="${p.name}">
						</a>
						...
						<div class="caption" style="font-size: 14px;">
							...
							<p style="padding: 3px; font-size: 15px; text-align: center; font-weight: bold;">
								<c:choose>
									...
									<c:otherwise>
										<span style="text-decoration: line-through; color: gray; font-weight: bold;">
											<f:formatNumber value="${p.unitPrice}" pattern="#,###" /> VNĐ
										</span>
									</c:otherwise>
								</c:choose>
