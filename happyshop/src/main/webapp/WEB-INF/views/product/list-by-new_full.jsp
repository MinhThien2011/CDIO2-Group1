...
<c:forEach var="p" items="${list1}" >
	<div class="col-sm-3" style="padding: 5px 5px 5px 5px">
		<div class="thumbnail" style="border-radius: 15px; border:2px solid #000; overflow: hidden">
			<a href="/product/detail/${p.id}" >
					...
					<c:choose>
						...
						<p style="background-color: red; width: 30px; height: 30px; text-align: right; float: right;position: relative;border-radius: 30px">
							<span 
								style="margin-left: -35px;margin-top: 5px;font-size: 14px;color: #fff;position: absolute;"> -<f:formatNumber value="${p.discount}" type="percent" />
							</span>
						</p> 
						</c:when>
						<c:otherwise>
