	...
	<div id="carousel-example" class="carousel slide hidden-xs"
		...
		<div class="carousel-inner">
			...
			<div class="item active"  >
				<div class="row">
					<div style="width: 55px;margin-left: 13px;padding-left: 20px">
					...
					<c:forEach var="p" items="${list}" begin="0" end="3">
						<div class="col" style="padding: 5px 10px 5px 5px">
							<div class="thumbnail" style="border-radius: 20px; border:2px solid #000">
								<a href="/product/detail/${p.id}"> <c:choose>
										<c:when test="${p.discount > 0 }">
											<p
												...
												<span
													style="margin-left: -35px; margin-top: 5px; font-size: 14px; color: #fff; position: absolute;">
								...
								<div class="caption">
									<p style="padding: 3px;font-size: 15px; text-align: center; color: black">
										<b>${p.name}</b>
									</p>
									<p
